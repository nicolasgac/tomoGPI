...
template class Iter3D<RegularSamplingProjector_compute_CUDA_mem_CPU, VIBackProjector_compute_OCL_mem_CPU,HuberRegularizer_CPU,GeneralizedGaussianRegularizer_CPU,Convolution3D_CPU,Volume_CPU,Sinogram3D_CPU,float>; // 32-bit unsigned image
template class Iter3D<RegularSamplingProjector_compute_CUDA_mem_CPU, VIBackProjector_compute_OCL_mem_CPU,HuberRegularizer_CPU,GeneralizedGaussianRegularizer_CPU,Convolution3D_CPU,Volume_CPU,Sinogram3D_CPU,double>; // 64-bit signed image
...
template class Iter3D_compute_CUDA_OCL<RegularSamplingProjector_compute_CUDA_mem_CPU, VIBackProjector_compute_OCL_mem_CPU,HuberRegularizer_CPU,GeneralizedGaussianRegularizer_CPU,Convolution3D_CPU,Volume_CPU,Sinogram3D_CPU,float>; // 32-bit unsigned image
template class Iter3D_compute_CUDA_OCL<RegularSamplingProjector_compute_CUDA_mem_CPU, VIBackProjector_compute_OCL_mem_CPU,HuberRegularizer_CPU,GeneralizedGaussianRegularizer_CPU,Convolution3D_CPU,Volume_CPU,Sinogram3D_CPU,double>; // 64-bit unsigned image
