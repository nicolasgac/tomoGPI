#ifndef _BACKPROJECTION_KERNEL_1_GE_H_
#define _BACKPROJECTION_KERNEL_1_GE_H_
 ...
 */
template <typename T>
__global__ void backprojection_VIB_kernel_v0_1reg_GE(T *volume_g,int phi_start,int zn_start,int N_sLphi,int vn_start)
{
