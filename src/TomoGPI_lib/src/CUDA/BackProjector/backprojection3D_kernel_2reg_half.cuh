#ifndef _BACKPROJECTION_KERNEL_HALF_2_H_
#define _BACKPROJECTION_KERNEL_HALF_2_H_
 ...
 */
__global__ void backprojection_VIB_kernel_v0_2reg_half(unsigned short *volume_g,int phi_start,int zn_start,int N_sLphi,int vn_start)
{
...
#endif // #ifndef _BACKPROJECTION_KERNEL_HALF_2_H_
