#ifndef _BACKPROJECTION_KERNEL_HALF_UM_8_H_
#define _BACKPROJECTION_KERNEL_HALF_UM_8_H_
 ...
 */
__global__ void backprojection_VIB_kernel_v0_8reg_half_UM(half *volume_g,int N_sLphi)
{
