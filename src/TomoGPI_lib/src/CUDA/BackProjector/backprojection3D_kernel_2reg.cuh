#ifndef _BACKPROJECTION_KERNEL_2_H_
#define _BACKPROJECTION_KERNEL_2_H_
 ...
 */
template <typename T>
__global__ void backprojection_VIB_kernel_v0_2reg(T *volume_g,int phi_start,int zn_start,int N_sLphi,int vn_start)
{
